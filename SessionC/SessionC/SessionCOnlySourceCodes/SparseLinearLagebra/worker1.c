...
int main(int argc, char **argv){
	...
	//receive_int_array(Master, row_ptr, nrows + 1);
	
	/* Receive values array from master */
	//receive_int_array(Master, values, num_of_no_zeros);
	
	/* Receive col_ind array from master */
	//receive_int_array(Master, col_ind, num_of_no_zeros);	
	
	/* Receive x array from master */
	//receive_int_array(Master, x, ncolumns);		
